...
import { PriceModel } from "../../data/services/bitcoin/models/price.model";
import { Card } from "../../components/layout/card";
import { ArrowBarLeft, ArrowDownCircleFill, ArrowUpCircleFill } from "react-bootstrap-icons";
import { Col, Row } from "react-bootstrap";
import dayjs from "dayjs";

export interface CoinInfoViewProps extends PriceModel {
...
export class CoinInfoView extends Component<CoinInfoViewProps, CoinInfoViewState> {
    ...
    componentDidUpdate (prevProps: Readonly<CoinInfoViewProps>, prevState: Readonly<CoinInfoViewState>, snapshot?: any) {
